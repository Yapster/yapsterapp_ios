...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.facebook_page_connection_flag'
        db.add_column(u'users_settings', 'facebook_page_connection_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.facebook_page_id'
        db.add_column(u'users_settings', 'facebook_page_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_page_connection_flag'
        db.add_column(u'users_userinfo', 'facebook_page_connection_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_page_id'
        db.add_column(u'users_userinfo', 'facebook_page_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.facebook_page_connection_flag'
        db.delete_column(u'users_settings', 'facebook_page_connection_flag')

        # Deleting field 'Settings.facebook_page_id'
        db.delete_column(u'users_settings', 'facebook_page_id')

        # Deleting field 'UserInfo.facebook_page_connection_flag'
        db.delete_column(u'users_userinfo', 'facebook_page_connection_flag')

        # Deleting field 'UserInfo.facebook_page_id'
        db.delete_column(u'users_userinfo', 'facebook_page_id')
    ...
    models = {
        ...
        u'users.settings': {
            ...
            'facebook_page_connection_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
