...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stream'
        db.create_table(u'stream_stream', (
            ('post_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_post_id', self.gf('django.db.models.fields.BigIntegerField')(blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stream', to=orm['auth.User'])),
            ('user_posted', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='posted_to', null=True, to=orm['auth.User'])),
            ('yap', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stream', to=orm['yap.Yap'])),
            ('reyap_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reyap', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='stream', null=True, to=orm['yap.Reyap'])),
        ...
        db.send_create_signal(u'stream', ['Stream'])


    def backwards(self, orm):
        # Deleting model 'Stream'
        db.delete_table(u'stream_stream')
