...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WebsiteLink'
        db.create_table(u'yap_websitelink', (
            ('website_link_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('website_link', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'yap', ['WebsiteLink'])

        # Deleting field 'Yap.web_link_flag'
        db.delete_column(u'yap_yap', 'web_link_flag')

        # Deleting field 'Yap.web_link'
        db.delete_column(u'yap_yap', 'web_link')

        # Adding field 'Yap.website_links_flag'
        db.add_column(u'yap_yap', 'website_links_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field website_links on 'Yap'
        m2m_table_name = db.shorten_name(u'yap_yap_website_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('yap', models.ForeignKey(orm[u'yap.yap'], null=False)),
            ('websitelink', models.ForeignKey(orm[u'yap.websitelink'], null=False))
        ))
        db.create_unique(m2m_table_name, ['yap_id', 'websitelink_id'])


    def backwards(self, orm):
        # Deleting model 'WebsiteLink'
        db.delete_table(u'yap_websitelink')

        # Adding field 'Yap.web_link_flag'
        db.add_column(u'yap_yap', 'web_link_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Yap.web_link'
        db.add_column(u'yap_yap', 'web_link',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Yap.website_links_flag'
        db.delete_column(u'yap_yap', 'website_links_flag')

        # Removing M2M table for field website_links on 'Yap'
        db.delete_table(db.shorten_name(u'yap_yap_website_links'))
