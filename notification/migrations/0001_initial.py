...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notification_notificationtype', (
            ('notification_type_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notification_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('notification_picture_path', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('notification_message', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('is_yapster_notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'notification', ['NotificationType'])

        # Adding model 'Notification'
        db.create_table(u'notification_notification', (
            ('notification_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_notification_id', self.gf('django.db.models.fields.BigIntegerField')(default=1)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['auth.User'])),
            ('notification_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['notification.NotificationType'])),
            ('origin_yap_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('origin_yap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yap.Yap'], null=True, blank=True)),
            ('origin_reyap_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('origin_reyap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yap.Reyap'], null=True, blank=True)),
            ('acting_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_sent', to=orm['auth.User'])),
            ('created_like_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_like', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['yap.Like'])),
            ('created_reyap_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_reyap', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['yap.Reyap'])),
            ('created_follower_request_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_follower_request', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['yap.FollowerRequest'])),
            ('created_listen_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_listen', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['yap.Listen'])),
            ('is_yapster_notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_verified_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_unverified_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_recommended_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_unrecommended_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_read_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_read_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('user_clicked_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_clicked_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'notification_notificationtype')
